---
title: License
description: LIA's license and what it means for you.
---

LIA — including its hardware designs, firmware, CAD files, and this documentation — is released under the **[Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International license (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/)**.

The full license text is in [`LICENSE`](https://github.com/JGAguado/LIA/blob/main/LICENSE) at the root of the repository.

## What that means in practice

- ✅ **Share** — copy and redistribute the material in any medium or format.
- ✅ **Adapt** — remix, transform, and build upon the material.
- ⚠️ **Attribution** — you must credit the LIA project, link the license, and note any changes.
