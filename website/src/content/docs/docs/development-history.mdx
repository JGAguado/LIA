...
import BuildGallery from '../../../components/BuildGallery.astro';
...
Photos from the bench along the way — prototype enclosures, antenna comparisons, and the status LED under test (also on the [homepage](/LIA/#build-gallery)):

<BuildGallery id="build-photos" />
